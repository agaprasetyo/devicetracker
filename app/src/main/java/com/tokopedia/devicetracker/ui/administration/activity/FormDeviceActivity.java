...
import com.tokopedia.devicetracker.ui.administration.presenters.FormDevicePresenter;

import butterknife.Bind;

public class FormDeviceActivity extends BaseActivity implements FormDevicePresenter.View {

    public static final String EXTRA_DEVICE_DATA = "EXTRA_DEVICE_DATA";

    private FormDevicePresenter presenter;
